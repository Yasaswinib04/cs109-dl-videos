...
const SEED_RULES = [
  ...
  ['Entertainment',    ['astrotalk','anytimeastro','anytime astro','divineastro','divine astro','astrosage','astroyogi','ganeshaspeaks','kundli','horoscope','netflix','spotify','hotstar','jiocinema','jiohotstar','prime video','sonyliv','zee5','youtube','bookmyshow','pvr','inox','cinepolis','audible','kindle','playstation','steam','xbox','google pla','googleplay','play store','gaming']],
...
const BRANDS = [
  ...
  ['Astrotalk',        ['astrotalk']],
  ['Anytime Astro',    ['anytimeastro', 'anytime astro']],
  ['Divine Astro',     ['divineastro', 'divine astro']],
  ['Amaha',            ['amaha']],
